...
public class PageBase {
    ...
    public static void scrollDownPagebbydimention(int dimention){
        js = (JavascriptExecutor) driver;
        js.executeScript("window.scrollBy(0, "+dimention+")");
    }
    public static void scrollDownPageUntleFound(WebElement targetElement){
        js = (JavascriptExecutor) driver;
    ...
    public void convertElementEditable(String elementName) {
        js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].removeAttribute('readonly','readonly')", elementName);
    }
}